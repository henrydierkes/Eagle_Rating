...
const Footer = () => {
  ...
  return (
    ...
    <p style={{ fontSize: '20px' }}>This project was created by a group in CS 370 Spring 2024. A* is Henry Dierkes, Tuan Vinh, Jonathan Wang, Wenzhuo Ma, Tung Dinh, and Henry Dierkes</p>
